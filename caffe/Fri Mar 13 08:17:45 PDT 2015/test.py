...
print("########### CLASS")
net = caffe.Classifier('./traffic_deploy.prototxt', './snapshot_iter_6500.caffemodel')
print("########### CLASSDONE")
...
for filename in os.listdir('images')[-500:]:
    ...
    total += diff
    count += 1
    print("C {}: D {}, T {}, P {}, A {}, B {}".format(count, diff, time, pTime, total/count, timeI[time]/timeC[time]))
